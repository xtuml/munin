...
namespace masld_AsyncLogger
{
                             ...
                             const ::SWA::String&  maslp_message )
  {
    ...
    {
      case ::masld_Logger::maslt_Priority::index_masle_Trace      : masls_trace      (maslp_logger,maslp_message); break;
      case ::masld_Logger::maslt_Priority::index_masle_Debug      : masls_debug      (maslp_logger,maslp_message); break;
      case ::masld_Logger::maslt_Priority::index_masle_Information: masls_information(maslp_logger,maslp_message); break;
      case ::masld_Logger::maslt_Priority::index_masle_Warning    : masls_warning    (maslp_logger,maslp_message); break;
      case ::masld_Logger::maslt_Priority::index_masle_Error      : masls_error      (maslp_logger,maslp_message); break;
      case ::masld_Logger::maslt_Priority::index_masle_Fatal      : masls_fatal      (maslp_logger,maslp_message); break;
    }
  }
                                     ...
                                     const ::masld_Logger::maslt_Priority& maslp_priority )
  {
    switch ( maslp_priority.getIndex() )
    {
      case ::masld_Logger::maslt_Priority::index_masle_Trace      : Logger{fmt::runtime(maslp_logger.s_str())}.set_level(Logger::Level::TRACE ); break;
      case ::masld_Logger::maslt_Priority::index_masle_Debug      : Logger{fmt::runtime(maslp_logger.s_str())}.set_level(Logger::Level::DEBUG ); break;
      case ::masld_Logger::maslt_Priority::index_masle_Information: Logger{fmt::runtime(maslp_logger.s_str())}.set_level(Logger::Level::INFO  ); break;
      case ::masld_Logger::maslt_Priority::index_masle_Warning    : Logger{fmt::runtime(maslp_logger.s_str())}.set_level(Logger::Level::WARN  ); break;
      case ::masld_Logger::maslt_Priority::index_masle_Error      : Logger{fmt::runtime(maslp_logger.s_str())}.set_level(Logger::Level::ERROR ); break;
      case ::masld_Logger::maslt_Priority::index_masle_Fatal      : Logger{fmt::runtime(maslp_logger.s_str())}.set_level(Logger::Level::FATAL ); break;
    }
  }

bool masls_enabled ( const ::masld_Logger::maslt_Priority& maslp_priority, const ::SWA::String&  maslp_logger ) {
    switch ( maslp_priority.getIndex() )
    {
        case ::masld_Logger::maslt_Priority::index_masle_Trace      : return Logger{fmt::runtime(maslp_logger.s_str())}.trace_enabled(); break;
        case ::masld_Logger::maslt_Priority::index_masle_Debug      : return Logger{fmt::runtime(maslp_logger.s_str())}.debug_enabled(); break;
        case ::masld_Logger::maslt_Priority::index_masle_Information: return Logger{fmt::runtime(maslp_logger.s_str())}.info_enabled();  break;
        case ::masld_Logger::maslt_Priority::index_masle_Warning    : return Logger{fmt::runtime(maslp_logger.s_str())}.warn_enabled();  break;
        case ::masld_Logger::maslt_Priority::index_masle_Error      : return Logger{fmt::runtime(maslp_logger.s_str())}.error_enabled(); break;
        case ::masld_Logger::maslt_Priority::index_masle_Fatal      : return Logger{fmt::runtime(maslp_logger.s_str())}.fatal_enabled(); break;
    }

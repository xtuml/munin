...
Note that the terms in brackets associated with the if..then..else..endif are
...
the condition was that an alternative sequence of events to emerge just that
an alternative sequence of events can be expected.

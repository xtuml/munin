...
TODO Remove the following sentence and link in favour of separate links to individual diagrams at the appropritate place in the document.
...
. Open a shell in the AEO_SVDC directory, run the following command
to launch the process:

  docker compose up

. Also open a separate shell in the AEReception directory, run the following command
to launch the process:

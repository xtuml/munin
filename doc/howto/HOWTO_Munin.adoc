...
=== Build each Depl0yment

IMPORTANT: Before this step, all of the application domains must be built
as demonstrated in the previous step.

Each of the three deployments needs to be built

* AER containing the Reception domain
* AEO_SVDC containing both Ordering and Sequence Verification domains
* iStore containing the iStore domain

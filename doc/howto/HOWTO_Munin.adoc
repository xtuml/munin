...
which for the MUNIN project is constrained to use the PLUS domain-specific language. 
...
IMPORTANT: Before this step, all three of the deployments must be built
as demonstrated in the previous step.
